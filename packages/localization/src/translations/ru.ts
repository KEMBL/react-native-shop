export default {
  ...
  'remove shipment address': 'удалить адрес(a) доставки',
  'pickup address': 'адрес самовывоза',
  'save shipment address': 'сохранить адрес доставки',
  'pickup here': 'заберу отсюда',
  'delivery here': 'доставить сюда',
  ph: 'т',
  delivery: 'доставка',
  pickup: 'самовывоз',
  addressee: 'получатель',
  checkout: 'оформить заказ',
  'review your order': 'ваш заказ',
  'take goods from the nearest pickup point': 'самовывоз из ближайшей точки выдачи',
  ...
  surname: 'фамилия',
  'e-mail': 'e-mail',
  'note to a delivery man': 'дополнительная информация для доставщика',
  'phone number': 'Номер телефона',
  address1: 'улица, дом',
  address2: 'подъезд, квартира',
  city: 'город',
  'you can pickup items at address below': 'вы можете забрать покупки по указанному ниже адресу',
